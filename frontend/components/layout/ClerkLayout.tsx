...
const clerkNavigation = [
  { name: 'Dashboard', href: '/clerk/dashboard', icon: Home },
  { name: 'Assigned Tasks', href: '/clerk/tasks/assigned', icon: FileText },
  { name: 'Pending Review', href: '/clerk/tasks/pending', icon: Clock },
  { name: 'In Progress', href: '/clerk/tasks/working', icon: AlertTriangle },
]
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/20">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              <button
                onClick={() => window.location.href = '/clerk/dashboard'}
              ...
              <div className="flex items-center space-x-3 pl-3 border-l border-slate-200">
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-500">CLERK • {userId}</p>
                </div>
      ...
      `}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-200">
          <div className="bg-amber-50 rounded-xl p-4">
            <h3 className="text-sm font-semibold text-slate-900 mb-3">Clerk Information</h3>
            <div className="space-y-2">
              <div>
                <p className="text-xs text-slate-500">Role</p>
                <p className="text-sm font-medium text-slate-900">CLERK</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-slate-900">Today, 09:00 AM</p>
              </div>
              <div>
                <p className="text-xs text-slate-500">Access Level</p>
                <p className="text-xs text-slate-600">Task Execution & Processing</p>
              </div>
            </div>
          </div>
        </div>
