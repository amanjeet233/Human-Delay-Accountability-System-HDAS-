...
const adminNavigation = [
  ...
  { name: 'Process & SLA Config', href: '/admin/processes', icon: Settings },
  { name: 'All Requests', href: '/admin/requests', icon: FileText },
  { name: 'Escalations', href: '/admin/escalations', icon: AlertTriangle },
  { name: 'Audit & Compliance', href: '/admin/audit', icon: Shield },
  { name: 'Feature Flags', href: '/admin/features', icon: Flag },
  { name: 'Governance Analytics', href: '/admin/analytics', icon: BarChart3 },
]
              ...
              <div className="flex items-center ml-4 lg:ml-0">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">HDAS - Human Delay Accountability System</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3 pl-3 border-l border-slate-200">
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-500">ADMIN • {userId}</p>
                </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-200">
          <div className="bg-slate-50 rounded-xl p-4">
            ...
            <div className="space-y-2">
              ...
              {department && (
                <div>
                  <p className="text-xs text-slate-500">Office / Department</p>
              ...
              <div>
                ...
                <p className="text-xs text-slate-600">Full System Control</p>
              </div>
            </div>
          </div>
        </div>
