...
const citizenNavigation = [
  ...
  { name: 'New Request', href: '/citizen/requests/new', icon: FileText },
  { name: 'My Requests', href: '/citizen/requests/my', icon: Clock },
]
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3 pl-3 border-l border-slate-200">
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-500">CITIZEN • {userId}</p>
                </div>
      ...
      `}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-200">
          <div className="bg-blue-50 rounded-xl p-4">
            <h3 className="text-sm font-semibold text-slate-900 mb-3">Citizen Information</h3>
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-slate-900">Today, 10:30 AM</p>
              </div>
              <div>
                <p className="text-xs text-slate-500">Access Level</p>
                <p className="text-xs text-slate-600">Request Submission & Tracking</p>
              </div>
            </div>
          </div>
        </div>
